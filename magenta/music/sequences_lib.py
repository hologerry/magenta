...
def infer_dense_chords_for_sequence(sequence,
    ...
    if is_quantized_sequence(sequence):
        def note_start(note): return note.quantized_start_step
        def note_end(note): return note.quantized_end_step
    else:
        def note_start(note): return note.start_time
        def note_end(note): return note.end_time
