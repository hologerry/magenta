...
from tensorflow.contrib.cudnn_rnn.python.layers import cudnn_rnn  # noqa
from tensorflow.python.util import nest  # noqa
...
class LstmDecodeResults(collections.namedtuple('LstmDecodeResults', ('rnn_input', 'rnn_output', 'samples', 'final_state', 'final_sequence_lengths'))):  # noqa
    pass


class Seq2SeqLstmDecoderOutput(collections.namedtuple('BasicDecoderOutput', ('rnn_input', 'rnn_output', 'sample_id'))):  # noqa
    pass
