...
flags.DEFINE_string(
    'raw_data_file', 'svg_vae_data/glyphs-parquetio-train/glyphs-parquetio',
    'File where the raw data is (in parquetio format).')
flags.DEFINE_string(
    'final_data_file', 'svg_vae_data/final-dataset-train/final-dataset-train',
    'File where the final data will be saved (in tfrecord format).')
flags.DEFINE_string(
    'final_stats_file', 'svg_vae_data/final-dataset-train/final-dataset-stats',
