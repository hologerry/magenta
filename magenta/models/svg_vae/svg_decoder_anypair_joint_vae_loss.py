...
class SVGDecoder(t2t_model.T2TModel):
    ...
    def pretrained_visual_encoder(self, features, hparams, train):
        ...
        with tf.variable_scope(tf.VariableScope(tf.AUTO_REUSE, ''),
            ...
            sampled_bottleneck_source, dec_out_source, losses_source = vae.vae_internal(vae_features_source, hparams, train)
            ...
            sampled_bottleneck_target, dec_out_target, losses_target  = vae.vae_internal(vae_features_target, hparams, train)
