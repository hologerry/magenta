...
ModelState = collections.namedtuple('ModelState', ['inputs', 'rnn_state', 'control_events', 'control_state'])
...
class EventSequenceRnnModel(mm.BaseModel):
    ...
    def _generate_events(self, num_steps, primer_events, temperature=1.0,
        ...
        generate_step_fn = functools.partial(
            ...
            extend_control_events_callback=extend_control_events_callback if control_events is not None else None,
